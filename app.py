...
if "openai_model" not in st.session_state:
    ...
    def vote():
        st.write("Anka AI Inštruktor je eden prvih brezplačnih Matematičnih AI inštruktorjev, ki deluje kot neprofitna pobuda! 🎓🚀" if st.session_state.language == "Slovene" else "Anka AI Tutor is one of the first free Math AI tutors operating as a non-profit initiative! 🎓🚀") 
        st.write(" ")
